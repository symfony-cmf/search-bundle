...
namespace Symfony\Cmf\Bundle\SearchBundle\Tests\Unit\DependencyInjection;
...
class XmlSchemaTest extends XmlSchemaTestCase
{
    public function testSchema()
    {
        ...
        $this->assertSchemaAcceptsXml($xmlFiles, __DIR__.'/../../../Resources/config/schema/search-1.0.xsd');
    }
}
